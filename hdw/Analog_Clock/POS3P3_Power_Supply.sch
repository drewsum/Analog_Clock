...
AR Path="/5E939D31/5C26EF0D" Ref="L401"  Part="1" 
...
AR Path="/5E939D31/5E2AA96A" Ref="C404"  Part="1" 
F 0 "C404" H 4575 3070 50  0000 L CNN
F 1 "0.1uF" H 4575 2870 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 4588 2820 50  0001 C CNN
F 3 "" H 4575 3070 50  0001 C CNN
F 4 "0603" H 4400 3070 50  0000 R CNN "display_footprint"
F 5 "50V" H 4400 2970 50  0000 R CNN "Voltage"
F 6 "X7R" H 4400 2870 50  0000 R CNN "Dielectric"
F 7 "399-7845-1-ND" H 4975 3470 60  0001 C CNN "Digi-Key PN"
	1    4550 2970
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5E939D31/5E2AA96B" Ref="#PWR0408"  Part="1" 
...
AR Path="/5E939D31/5C288B4E" Ref="#PWR0412"  Part="1" 
...
AR Path="/5E939D31/5C28E698" Ref="#PWR0409"  Part="1" 
...
AR Path="/5E939D31/5C28FDD2" Ref="C405"  Part="1" 
...
AR Path="/5E939D31/5E2AA97D" Ref="C403"  Part="1" 
F 0 "C403" H 4215 4870 50  0000 L CNN
F 1 "10nF" H 4215 4670 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 4228 4620 50  0001 C CNN
F 3 "" H 4215 4870 50  0001 C CNN
F 4 "0603" H 4040 4870 50  0000 R CNN "display_footprint"
F 5 "50V" H 4040 4770 50  0000 R CNN "Voltage"
F 6 "X7R" H 4040 4670 50  0000 R CNN "Dielectric"
F 7 "399-7842-1-ND" H 270 550 50  0001 C CNN "Digi-Key PN"
	1    4190 4770
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5E939D31/5C294444" Ref="#PWR0406"  Part="1" 
...
AR Path="/5E939D31/5C2959E0" Ref="R407"  Part="1" 
F 0 "R407" H 8140 3810 50  0000 R CNN
F 1 "562k" V 8220 3810 40  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 8220 3810 50  0001 C CNN
...
AR Path="/5E939D31/5E2AA981" Ref="R408"  Part="1" 
F 0 "R408" H 8140 4720 50  0000 R CNN
F 1 "180k" V 8220 4720 40  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 8220 4720 50  0001 C CNN
...
AR Path="/5E939D31/5E2AA982" Ref="#PWR0415"  Part="1" 
...
AR Path="/5E939D31/5C298A57" Ref="#PWR0414"  Part="1" 
...
AR Path="/5E939D31/5C3650A7" Ref="TP401"  Part="1" 
...
AR Path="/5E939D31/5E06F7D6" Ref="R405"  Part="1" 
F 0 "R405" V 7420 3040 50  0000 C CNN
...
AR Path="/5E939D31/5E08F4A3" Ref="#PWR0413"  Part="1" 
...
AR Path="/5E939D31/5E2AA9B3" Ref="C406"  Part="1" 
F 0 "C406" H 8695 3370 50  0000 L CNN
F 1 "0.1uF" H 8695 3170 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 8708 3120 50  0001 C CNN
F 3 "" H 8695 3370 50  0001 C CNN
F 4 "0603" H 8520 3370 50  0000 R CNN "display_footprint"
F 5 "50V" H 8520 3270 50  0000 R CNN "Voltage"
F 6 "X7R" H 8520 3170 50  0000 R CNN "Dielectric"
F 7 "399-7845-1-ND" H 9095 3770 60  0001 C CNN "Digi-Key PN"
	1    8670 3270
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5E939D31/5E2AA9B5" Ref="#PWR0417"  Part="1" 
F 0 "#PWR0417" H 8670 3170 50  0001 C CNN
...
AR Path="/5E939D31/5DEA6B71" Ref="#PWR0416"  Part="1" 
...
AR Path="/5E939D31/5E2B5758" Ref="R404"  Part="1" 
F 0 "R404" V 7190 2710 50  0000 C CNN
F 1 "10" V 7290 2710 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 7290 2710 50  0001 C CNN
...
AR Path="/5E939D31/5E2B5762" Ref="R406"  Part="1" 
F 0 "R406" V 7650 2710 50  0000 C CNN
F 1 "10" V 7750 2710 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 7750 2710 50  0001 C CNN
...
AR Path="/5E939D31/5E434D63" Ref="#PWR0418"  Part="1" 
...
U 1 1 5E4352D6
P 9060 2960
F 0 "#FLG0401" H 9060 3035 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:ZXMS6004FFTA Q402
U 1 1 5EB3BE62
P 5020 7210
...
U 1 1 5EB3CD64
P 5120 7410
F 0 "#PWR0411" H 5120 7160 50  0001 C CNN
...
U 1 1 5EB3E1B6
P 5120 7010
F 0 "#PWR0410" H 5120 6860 50  0001 C CNN
...
U 1 1 5EB40BA6
P 4390 7690
F 0 "#PWR0407" H 4390 7440 50  0001 C CNN
...
AR Path="/5E939D31/5EB41C61" Ref="R403"  Part="1" 
F 0 "R403" H 4310 6980 50  0000 R CNN
F 1 "10k" V 4390 6980 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 4390 6980 50  0001 C CNN
...
U 1 1 5EB47981
P 3680 7130
F 0 "#PWR0405" H 3680 6880 50  0001 C CNN
...
AR Path="/5E939D31/5EB895CA" Ref="R401"  Part="1" 
F 0 "R401" V 2030 6700 50  0000 C CNN
...
AR Path="/5E939D31/5EBB9A75" Ref="C402"  Part="1" 
F 0 "C402" H 3705 7080 50  0000 L CNN
F 1 "10uF" H 3705 6880 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 3718 6830 50  0001 C CNN
F 3 "" H 3705 7080 50  0001 C CNN
F 4 "0603" H 3530 7080 50  0000 R CNN "display_footprint"
F 5 "10V" H 3530 6980 50  0000 R CNN "Voltage"
F 6 "X5R" H 3530 6880 50  0000 R CNN "Dielectric"
F 7 "490-10474-1-ND" H 3680 6980 50  0001 C CNN "Digi-Key PN"
	1    3680 6980
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5E939D31/5DEA7247" Ref="#PWR0403"  Part="1" 
...
AR Path="/5E939D31/5E2AA97B" Ref="R402"  Part="1" 
F 0 "R402" H 2690 3810 50  0000 R CNN
F 1 "10k" V 2770 3810 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 2770 3810 50  0001 C CNN
...
AR Path="/5E939D31/5E2AA972" Ref="#PWR0401"  Part="1" 
...
AR Path="/5E939D31/5E2AA970" Ref="#PWR0402"  Part="1" 
...
AR Path="/5E939D31/5C2703C2" Ref="C401"  Part="1" 
