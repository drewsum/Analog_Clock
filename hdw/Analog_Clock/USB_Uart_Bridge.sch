...
F 1 "+5V_USB" H 3620 3030 50  0000 C CNN
...
F 2 "Capacitors_SMD:C_0603" H 4688 4690 50  0001 C CNN
F 3 "" H 4675 4940 50  0001 C CNN
F 4 "0603" H 4500 4940 50  0000 R CNN "display_footprint"
F 5 "10V" H 4500 4840 50  0000 R CNN "Voltage"
F 6 "X5R" H 4500 4740 50  0000 R CNN "Dielectric"
F 7 "490-16348-1-ND" H 5075 5340 60  0001 C CNN "Digi-Key PN"
	1    4650 4840
	1    0    0    -1  
$EndComp
$Comp
...
F 3 "" H 4650 4690 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 1330 4020 0    50   Output ~ 0
USB_UART_RX
Text GLabel 1330 4120 0    50   Input ~ 0
USB_UART_TX
NoConn ~ 2870 3290
NoConn ~ 2870 3390
NoConn ~ 8610 3490
...
U 1 1 5BAF2627
P 2710 2780
F 0 "R?" H 2650 2780 50  0000 R CNN
...
F 7 "RMCF0402FT10K0CT-ND" H 3010 3180 60  0001 C CNN "Digi-Key PN"
	1    2710 2780
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E9A6734
P 2070 2780
F 0 "R?" H 2010 2780 50  0000 R CNN
...
F 7 "RMCF0402FT10K0CT-ND" H 2370 3180 60  0001 C CNN "Digi-Key PN"
	1    2070 2780
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5E9C0D8F
P 8580 2450
F 0 "R?" H 8520 2450 50  0000 R CNN
...
F 7 "RMCF0402FT10K0CT-ND" H 8880 2850 60  0001 C CNN "Digi-Key PN"
	1    8580 2450
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5E9C26CC
P 8580 2600
F 0 "#PWR?" H 8580 2350 50  0001 C CNN
...
Wire Wire Line
	3420 2890 3420 2550
Text Notes 770  3820 0    50   ~ 0
ADD LEVEL SHIFTER/TRISTATE BUFFER STUFF
Wire Wire Line
	3420 2550 2710 2550
Wire Wire Line
	2710 2550 2710 2630
Connection ~ 3420 2550
Wire Wire Line
	2710 2550 2070 2550
Wire Wire Line
	2070 2550 2070 2630
Connection ~ 2710 2550
Wire Wire Line
	4460 3090 4880 3090
Wire Wire Line
	4170 3090 4460 3090
Connection ~ 4460 3090
Wire Wire Line
	3420 2550 4460 2550
Wire Wire Line
	4460 2550 4460 3090
