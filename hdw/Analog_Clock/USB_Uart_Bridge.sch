...
Wire Wire Line
	6810 3430 6950 3430
$Comp
L Custom_Library:C_Custom C1313
U 1 1 5BB03D51
P 7430 3860
F 0 "C1313" H 7455 3960 50  0000 L CNN
F 1 "0.1uF" H 7455 3760 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 7468 3710 50  0001 C CNN
F 3 "" H 7455 3960 50  0001 C CNN
F 4 "0603" H 7280 3960 50  0000 R CNN "display_footprint"
F 5 "50V" H 7280 3860 50  0000 R CNN "Voltage"
F 6 "X7R" H 7280 3760 50  0000 R CNN "Dielectric"
F 7 "399-7845-1-ND" H 7855 4360 60  0001 C CNN "Digi-Key PN"
	1    7430 3860
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5BB10D97
P 7430 3540
F 0 "#FLG01302" H 7430 3615 50  0001 C CNN
F 1 "PWR_FLAG" H 7430 3690 50  0000 C CNN
F 2 "" H 7430 3540 50  0001 C CNN
F 3 "~" H 7430 3540 50  0001 C CNN
	1    7430 3540
	1    0    0    -1  
$EndComp
Wire Wire Line
...
$EndComp
$Comp
L power:GND #PWR01342
U 1 1 5E9BAB6F
P 7430 4010
F 0 "#PWR01342" H 7430 3760 50  0001 C CNN
F 1 "GND" H 7430 3860 50  0000 C CNN
F 2 "" H 7430 4010 50  0001 C CNN
F 3 "" H 7430 4010 50  0001 C CNN
	1    7430 4010
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5E939F76/5F51B221" Ref="C1303"  Part="1" 
F 0 "C1303" H 3065 3780 50  0000 L CNN
F 1 "10uF" H 3065 3580 50  0000 L CNN
F 2 "Capacitors_SMD:C_0805" H 3078 3530 50  0001 C CNN
F 3 "" H 3065 3780 50  0001 C CNN
F 4 "0805" H 2890 3780 50  0000 R CNN "display_footprint"
F 5 "50V" H 2890 3680 50  0000 R CNN "Voltage"
F 6 "X5R" H 2890 3580 50  0000 R CNN "Dielectric"
F 7 "490-18664-1-ND" H 3465 4180 60  0001 C CNN "Digi-Key PN"
	1    3040 3680
	1    0    0    -1  
$EndComp
$Comp
...
F 3 "" H 4480 980 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 3340 2000 0    50   Input ~ 0
POS5_USB_PGOOD
$Comp
...
U 1 1 5F41FDCF
P 4710 2050
AR Path="/5C1D5CD8/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5C1D5CCA/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5C26E09A/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5D739492/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5E28CFDF/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5E36CE18/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5E3C80C8/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5E3C97B4/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5F28EEB2/5F41FDCF" Ref="C?"  Part="1" 
AR Path="/5E939F76/5F41FDCF" Ref="C1308"  Part="1" 
F 0 "C1308" H 4735 2150 50  0000 L CNN
F 1 "10uF" H 4735 1950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 4748 1900 50  0001 C CNN
F 3 "" H 4735 2150 50  0001 C CNN
F 4 "490-10474-1-ND" H 5135 2550 60  0001 C CNN "Digi-Key PN"
F 5 "0603" H 4560 2150 50  0000 R CNN "display_footprint"
F 6 "10V" H 4560 2050 50  0000 R CNN "Voltage"
F 7 "X5R" H 4560 1950 50  0000 R CNN "Dielectric"
	1    4710 2050
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F41FDD5
P 4710 2200
AR Path="/5D6B2673/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5D784813/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5D739492/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5E28CFDF/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5E36CE18/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5E3C80C8/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5E3C97B4/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5F28EEB2/5F41FDD5" Ref="#PWR?"  Part="1" 
AR Path="/5E939F76/5F41FDD5" Ref="#PWR01329"  Part="1" 
F 0 "#PWR01329" H 4710 1950 50  0001 C CNN
F 1 "GND" H 4715 2027 50  0000 C CNN
F 2 "" H 4710 2200 50  0001 C CNN
...
Wire Wire Line
	4950 1760 4710 1760
Connection ~ 4710 1760
$Comp
L power:GND #PWR?
U 1 1 5F41FDDF
P 3640 2100
AR Path="/5D6B2673/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5D784813/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5D739492/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5E28CFDF/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5E36CE18/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5E3C80C8/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5E3C97B4/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5F28EEB2/5F41FDDF" Ref="#PWR?"  Part="1" 
AR Path="/5E939F76/5F41FDDF" Ref="#PWR01320"  Part="1" 
F 0 "#PWR01320" H 3640 1850 50  0001 C CNN
F 1 "GND" H 3645 1927 50  0000 C CNN
F 2 "" H 3640 2100 50  0001 C CNN
...
U 1 1 5F41FDE5
P 3870 2610
AR Path="/5D6B2673/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5D784813/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5D739492/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5E28CFDF/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5E36CE18/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5E3C80C8/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5E3C97B4/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5F28EEB2/5F41FDE5" Ref="#PWR?"  Part="1" 
AR Path="/5E939F76/5F41FDE5" Ref="#PWR01322"  Part="1" 
F 0 "#PWR01322" H 3870 2360 50  0001 C CNN
F 1 "GND" H 3875 2437 50  0000 C CNN
F 2 "" H 3870 2610 50  0001 C CNN
...
U 1 1 5F41FDEF
P 3870 2460
AR Path="/5C1D5CD8/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5C1D5CCA/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5C26E09A/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5D739492/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5E28CFDF/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5E36CE18/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5E3C80C8/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5E3C97B4/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5F28EEB2/5F41FDEF" Ref="C?"  Part="1" 
AR Path="/5E939F76/5F41FDEF" Ref="C1305"  Part="1" 
F 0 "C1305" H 3895 2560 50  0000 L CNN
F 1 "0.1uF" H 3895 2360 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 3908 2310 50  0001 C CNN
F 3 "" H 3895 2560 50  0001 C CNN
F 4 "399-7845-1-ND" H 4295 2960 60  0001 C CNN "Digi-Key PN"
F 5 "0603" H 3720 2560 50  0000 R CNN "display_footprint"
F 6 "50V" H 3720 2460 50  0000 R CNN "Voltage"
F 7 "X7R" H 3720 2360 50  0000 R CNN "Dielectric"
	1    3870 2460
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F41FDF5
P 3870 2310
AR Path="/5F28EEB2/5F41FDF5" Ref="#PWR?"  Part="1" 
AR Path="/5E939F76/5F41FDF5" Ref="#PWR01321"  Part="1" 
F 0 "#PWR01321" H 3870 2160 50  0001 C CNN
F 1 "+3.3V" H 3870 2450 50  0000 C CNN
...
U 1 1 5F41FDFB
P 3640 1900
AR Path="/5F28EEB2/5F41FDFB" Ref="#PWR?"  Part="1" 
AR Path="/5E939F76/5F41FDFB" Ref="#PWR01319"  Part="1" 
F 0 "#PWR01319" H 3640 1750 50  0001 C CNN
F 1 "+3.3V" H 3640 2040 50  0000 C CNN
F 2 "" H 3640 1900 50  0001 C CNN
F 3 "" H 3640 1900 50  0001 C CNN
	1    3640 1900
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F41FE02
P 3640 2000
AR Path="/5F28EEB2/5F41FE02" Ref="U?"  Part="1" 
AR Path="/5E939F76/5F41FE02" Ref="U1303"  Part="1" 
F 0 "U1303" H 3740 2150 50  0000 L CNN
F 1 "74LVC1G17" H 3740 1920 50  0000 L CNN
F 2 "TO_SOT_Packages_SMD:SOT-353_SC-70-5" H 3640 2000 50  0001 C CNN
F 3 "http://www.ti.com/lit/sg/scyt129e/scyt129e.pdf" H 3740 2150 50  0001 C CNN
F 4 "296-11934-1-ND" H 3640 2000 50  0001 C CNN "Digi-Key PN"
	1    3640 2000
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F424C81
P 4450 1760
AR Path="/5E939EAF/5F424C81" Ref="R?"  Part="1" 
AR Path="/5E939F76/5F424C81" Ref="R1307"  Part="1" 
F 0 "R1307" V 4350 1760 50  0000 C CNN
F 1 "1k" V 4450 1760 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 4450 1760 50  0001 C CNN
F 3 "" H 4450 1760 50  0001 C CNN
F 4 "0603" V 4550 1760 50  0001 C CNN "display_footprint"
F 5 "1%" V 4650 1760 50  0001 C CNN "Tolerance"
F 6 "1/10W" V 4750 1760 50  0001 C CNN "Wattage"
F 7 "311-1.00KHRCT-ND" H 4450 1760 50  0001 C CNN "Digi-Key PN"
	1    4450 1760
	0    1    -1   0   
$EndComp
Wire Wire Line
